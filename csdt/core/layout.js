...
export function init(isAutoFill) {
  ...
  this.asset_path = "/static/csnap_infinity/csdt/";
  ////////////////////////////////
...
export function createControlBar() {
  ...
  if (!IDE_Morph.prototype.hideControlBtns)
    this.controlBar.add(stageSizeButton); //Hides the stage sizing toggle for tutorials
...
export function createSpriteBar() {
  ...
  function addRotationStyleButton(rotationStyle) {
    ...
    if (
      myself.currentSprite instanceof StageMorph ||
  ...
  if (
    this.currentSprite instanceof StageMorph ||
    IDE_Morph.prototype.hideSpriteBar
  ) {
    padlock.hide();
  }
...
export function fixLayout(situation) {
  ...
  if (situation !== "refreshPalette") {
    ...
    if (this.isEmbedMode) {
      ...
      ); // Default is 1 for initScaleSize
