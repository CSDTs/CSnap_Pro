...
CSDTCloud.prototype.init = function () {
...
CSDTCloud.MAX_FILE_SIZE = 10 * 1024 * 1024;

CSDTCloud.prototype.knownDomains = {
    'Snap!Cloud': '',
    'Snap!Cloud (cs10)': 'https://snap-CSDTCloud.cs10.org',
    'Snap!Cloud (staging)': 'https://snap-staging.cs10.org',
    'localhost': 'http://localhost:8080',
    'localhost (secure)': 'https://localhost:4431'
};

CSDTCloud.prototype.defaultDomain = CSDTCloud.prototype.knownDomains['Snap!Cloud'];

CSDTCloud.prototype.determineCloudDomain = function () {
    ...
    Object.keys(domainMap).some(function (name) {
        ...
        if (CSDTCloud.isMatchingDomain(currentDomain, server)) {
            cloudDomain = server;
            return true;
        }
        return false;
...
CSDTCloud.isMatchingDomain = function (client, server) {
...
CSDTCloud.prototype.parseDict = function (src) {
    var dict = {};
    if (!src) {
        return dict;
    }
...
CSDTCloud.prototype.encodeDict = function (dict) {
    var str = '',
        pair,
        key;
    if (!dict) {
...
CSDTCloud.genericErrorMessage =
    'There was an error while trying to access\n' +
    'a Snap!Cloud service. Please try again later.';

CSDTCloud.prototype.genericError = function () {
    throw new Error(CSDTCloud.genericErrorMessage);
};
...
CSDTCloud.prototype.request = function (
    method,
    path,
    onSuccess,
    onError,
            ...
            if (request.readyState === 4) {
                if (request.responseText) {
                    ...
                    if (onError) {
                        onError.call(
                            null,
                            errorMsg || CSDTCloud.genericErrorMessage,
                            myself.url
                        );
                    } else {
                        myself.genericError();
...
CSDTCloud.prototype.withCredentialsRequest = function (
    method,
    path,
    onSuccess,
    onError,
...
CSDTCloud.prototype.initSession = function (onSuccess) {
    var myself = this;
...
CSDTCloud.prototype.checkCredentials = function (onSuccess, onError, response) {
    var myself = this;
    this.getCurrentUser(
        function (user) {
            if (user.username) {
...
CSDTCloud.prototype.getCurrentUser = function (onSuccess, onError) {
    this.request(
        'GET',
...
CSDTCloud.prototype.getUser = function (username, onSuccess, onError) {
    this.request(
        'GET',
...
CSDTCloud.prototype.logout = function (onSuccess, onError) {
    this.username = null;
    this.getCSRFToken();
    $.post('/accounts/logout/', {}, onSuccess, 'json').fail(onError);
};

CSDTCloud.prototype.login = function (
    username,
    password,
    persist,
    onSuccess,
...
CSDTCloud.prototype.signup = function (
    username,
    password,
    passwordRepeat,
    email,
...
CSDTCloud.prototype.changePassword = function (
    password,
    newPassword,
    passwordRepeat,
    onSuccess,
...
CSDTCloud.prototype.resetPassword = function (username, onSuccess, onError) {
    this.request(
        'POST',
...
CSDTCloud.prototype.resendVerification = function (username, onSuccess, onError) {
    this.request(
        'POST',
...
CSDTCloud.prototype.updateURL = function (URL) {
    if (window.history !== undefined && window.history.pushState !== undefined) {
        window.history.pushState({}, "", "/projects/" + URL + "/run");
    }
};

CSDTCloud.prototype.dataURItoBlob = function (dataURI, type) {
    let binary;
...
CSDTCloud.prototype.saveProject = function (projectName, body, onSuccess, onError) {
...
CSDTCloud.prototype.saveFile = function (file, onSuccess, onError) {
    $.ajax({
        type: 'PUT',
...
CSDTCloud.prototype.createProject = function (projectName, dataNum, imgNum, onSuccess, onError) {
...
CSDTCloud.prototype.getProjectList = function (onSuccess, onError, withThumbnail) {
...
CSDTCloud.prototype.getPublishedProjectList = function (
    username,
    page,
    pageSize,
    searchTerm,
...
CSDTCloud.prototype.getThumbnail = function (
    username,
    projectName,
    onSuccess,
    onError
...
CSDTCloud.prototype.getProject = function (proj, delta, onSuccess, onError) {
    this.request(
        'GET',
        proj.project_url,
        onSuccess,
...
CSDTCloud.prototype.getPublicProject = function (
    projectName,
    username,
    onSuccess,
    onError
...
CSDTCloud.prototype.getProjectMetadata = function (
    projectName,
    username,
    onSuccess,
    onError
...
CSDTCloud.prototype.getProjectVersionMetadata = function (
    projectName,
    onSuccess,
    onError
) {
...
CSDTCloud.prototype.getRemixes = function (
    username,
    projectName,
    page,
    pageSize,
...
CSDTCloud.prototype.deleteProject = function (
    projectName,
    username,
    onSuccess,
    onError
...
CSDTCloud.prototype.shareProject = function (
    projectName,
    username,
    onSuccess,
    onError
...
CSDTCloud.prototype.unshareProject = function (
    projectName,
    username,
    onSuccess,
    onError
...
CSDTCloud.prototype.publishProject = function (
    projectName,
    username,
    onSuccess,
    onError
...
CSDTCloud.prototype.unpublishProject = function (
    projectName,
    username,
    onSuccess,
    onError
...
CSDTCloud.prototype.updateNotes = function (
    projectName,
    notes,
    onSuccess,
    onError
...
CSDTCloud.prototype.updateProjectName = function (
    projectName,
    newName,
    onSuccess,
    onError
...
CSDTCloud.prototype.newCollection = function (
    collectionName,
    onSuccess,
    onError
) {
...
CSDTCloud.prototype.getCollectionMetadata = function (
    collectionUsername,
    collectionName,
    onSuccess,
    onError
...
CSDTCloud.prototype.getCollectionProjects = function (
    collectionUsername,
    page,
    pageSize,
    collectionName,
...
CSDTCloud.prototype.setCollectionThumbnail = function (
    collectionUsername,
    collectionName,
    thumbnailId,
    onSuccess,
...
CSDTCloud.prototype.updateCollectionDescription = function (
    collectionUsername,
    collectionName,
    description,
    onSuccess,
...
CSDTCloud.prototype.updateCollectionName = function (
    collectionUsername,
    collectionName,
    newName,
    onSuccess,
...
CSDTCloud.prototype.shareCollection = function (
    collectionUsername,
    collectionName,
    onSuccess,
    onError
...
CSDTCloud.prototype.unshareCollection = function (
    collectionUsername,
    collectionName,
    onSuccess,
    onError
...
CSDTCloud.prototype.publishCollection = function (
    collectionUsername,
    collectionName,
    onSuccess,
    onError
...
CSDTCloud.prototype.unpublishCollection = function (
    collectionUsername,
    collectionName,
    onSuccess,
    onError
...
CSDTCloud.prototype.addProjectToCollection = function (
    collectionUsername,
    collectionName,
    projectUsername,
    projectName,
...
CSDTCloud.prototype.removeProjectFromCollection = function (
    collectionUsername,
    collectionName,
    projectId,
    onSuccess,
...
CSDTCloud.prototype.getUserCollections = function (
    collectionUsername,
    page,
    pageSize,
    searchTerm,
...
CSDTCloud.prototype.getCollectionsContainingProject = function (
    username,
    projectName,
    page,
    pageSize,
...
CSDTCloud.prototype.getCollections = function (
    page,
    pageSize,
    searchTerm,
    onSuccess,
...
CSDTCloud.prototype.deleteCollection = function (
    collectionUsername,
    collectionName,
    onSuccess,
    onError
...
CSDTCloud.prototype.addEditorToCollection = function (
    collectionUsername,
    collectionName,
    editorUsername,
    onSuccess,
...
CSDTCloud.prototype.removeEditorFromCollection = function (
    collectionUsername,
    collectionName,
    editorUsername,
    onSuccess,
...
CSDTCloud.prototype.showProjectPath = function (username, projectname) {
...
CSDTCloud.prototype.getCSRFToken = function () {
...
CSDTCloud.prototype.getClassroomList = function (callBack, errorCall) {
